...
public class PersonajeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PersonajeBean personajesBean = (PersonajeBean) intent.getSerializableExtra("PERSONAJES_KEY");

        txtNombrePers.setText(personajesBean.getNombre());
        txtDescripcionPers.setText(personajesBean.getDescripcion());
        imgPers.setImageDrawable(ContextCompat.getDrawable(PersonajeActivity.this, personajesBean.getFoto()));
    }
